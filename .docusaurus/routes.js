    ...
    routes: [
      {
        ...
        routes: [
          {
            path: '/',
            component: ComponentCreator('/', '7f0'),
            routes: [
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/FAQ/cracks-sounds', 'e85'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/Main Part/gain-muscles', 'ae2'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/key-to-result',
                component: ComponentCreator('/Main Part/key-to-result', 'ddc'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/more-energy',
                component: ComponentCreator('/Main Part/more-energy', '256'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/save-muscles',
                component: ComponentCreator('/Main Part/save-muscles', '3a9'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/start-workout',
                component: ComponentCreator('/Main Part/start-workout', '695'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/Target-Losewight/easy-lose-weight',
                component: ComponentCreator('/Main Part/Target-Losewight/easy-lose-weight', '21f'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/Target-Losewight/energy-balance',
                component: ComponentCreator('/Main Part/Target-Losewight/energy-balance', 'ac3'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/Target-Losewight/fast-lose-weight',
                component: ComponentCreator('/Main Part/Target-Losewight/fast-lose-weight', 'f8a'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/Target-Losewight/lose-weight',
                component: ComponentCreator('/Main Part/Target-Losewight/lose-weight', 'b90'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/Main Part/Target-Losewight/slow-lose-weight',
                component: ComponentCreator('/Main Part/Target-Losewight/slow-lose-weight', '657'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              },
              {
                ...
                component: ComponentCreator('/WarmingUp/home-gear', '7d0'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/WarmingUp/quick-start',
                component: ComponentCreator('/WarmingUp/quick-start', '8f0'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
